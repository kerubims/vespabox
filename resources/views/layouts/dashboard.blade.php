            ...
            <header class="sticky top-0 z-20 bg-white/80 backdrop-blur-md border-b border-gray-200/60 h-16 flex items-center justify-between px-4 lg:px-6 shrink-0">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <form method="POST" action="/logout" class="inline">
                        @csrf
                        <button type="submit" class="flex items-center justify-center w-9 h-9 rounded-lg text-gray-500 hover:bg-red-50 hover:text-danger transition-all" title="Logout" id="logout-btn">
