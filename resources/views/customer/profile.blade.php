...
@section('content')
<div class="min-h-[70vh] animate-fade-in px-4 py-8">
    <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden">
            ...
            <div class="relative z-10 p-8">
                ...
                <form action="{{ route('customer.profile.updateInfo') }}" method="POST" class="space-y-5">
                    @csrf
                    @method('PATCH')
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden">
            ...
            <div class="relative z-10 p-8">
                ...
                <form action="{{ route('customer.profile.updatePassword') }}" method="POST" class="space-y-5">
                    @csrf
                    @method('PUT')
